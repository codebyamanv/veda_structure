...
function Banner() {
    ...
    return (
        ...
        >
            {/* Slide 1 */}
            <SplideSlide className="relative h-[600px] max-h-[600px] w-full lg:h-[600px] lg:max-h-[600px]">
                <div className="relative h-full w-full">
                    ...
                    <div className="absolute z-50 p-8 sm:p-12 md:p-16">
                        <div className="space-y-5">
                            <div className="w-fit rounded-full bg-white/90 px-4 py-1 text-orange-500">Spiritual wellness</div>
            ...
            <SplideSlide className="relative h-[600px] max-h-[600px] w-full lg:h-[600px] lg:max-h-[600px]">
                <div className="relative h-full w-full">
                    ...
                    <div className="absolute z-50 p-8 sm:p-12 md:p-16">
                        <div className="space-y-5">
                            <div className="w-fit rounded-full bg-white/90 px-4 py-1 text-orange-500">Traditional Puja Services</div>
